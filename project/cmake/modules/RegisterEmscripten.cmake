...
function(register_emscripten target)
    ...
    if(NOT CURRENT_COMPILER STREQUAL "EMSCRIPTEN")
        message(WARNING "register_emscripten called but not using Emscripten compiler. Current compiler: ${CURRENT_COMPILER}")
        message(WARNING "Please use the Emscripten toolchain file for WebAssembly builds.")
        message(WARNING "Creating regular executable instead.")
        # Fallback to regular executable
