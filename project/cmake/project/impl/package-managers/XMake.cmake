...
function(_detect_platform)
    if (NOT "${XREPO_PLATFORM}" STREQUAL "")
        return()  # already set by user, don't override
    endif()

    if (CMAKE_SYSTEM_NAME STREQUAL "Emscripten")
        set(XREPO_PLATFORM "wasm" PARENT_SCOPE)
        set(XREPO_ARCH "wasm32" PARENT_SCOPE)
        set(XREPO_TOOLCHAIN "emcc" PARENT_SCOPE)
    elseif (CMAKE_SYSTEM_NAME STREQUAL "Android")
        set(XREPO_PLATFORM "android" PARENT_SCOPE)
        set(XREPO_ARCH "${CMAKE_ANDROID_ARCH_ABI}" PARENT_SCOPE)
    elseif (CMAKE_SYSTEM_NAME STREQUAL "iOS")
        set(XREPO_PLATFORM "iphoneos" PARENT_SCOPE)
    elseif (CMAKE_SYSTEM_NAME STREQUAL "Darwin")
        set(XREPO_PLATFORM "macosx" PARENT_SCOPE)
    elseif (CMAKE_SYSTEM_NAME STREQUAL "Linux")
        set(XREPO_PLATFORM "linux" PARENT_SCOPE)
    elseif (CMAKE_SYSTEM_NAME STREQUAL "Windows")
        set(XREPO_PLATFORM "windows" PARENT_SCOPE)
    endif()

    # Auto-detect arch from CMake if not set by platform block above
    if (NOT "${XREPO_ARCH}" STREQUAL "")
        return()
    endif()

    if (CMAKE_SYSTEM_PROCESSOR MATCHES "x86_64|AMD64")
        set(XREPO_ARCH "x86_64" PARENT_SCOPE)
    elseif (CMAKE_SYSTEM_PROCESSOR MATCHES "i[3-6]86")
        set(XREPO_ARCH "i386" PARENT_SCOPE)
    elseif (CMAKE_SYSTEM_PROCESSOR MATCHES "arm64|aarch64")
        set(XREPO_ARCH "arm64" PARENT_SCOPE)
    elseif (CMAKE_SYSTEM_PROCESSOR MATCHES "armv7")
        set(XREPO_ARCH "armv7" PARENT_SCOPE)
    endif()
endfunction()
