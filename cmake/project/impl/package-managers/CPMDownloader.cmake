...
set(CPM_DOWNLOAD_VERSION
    "0.42.0"
    CACHE STRING "CPM version to download")
set(CPM_HASH_SUM
    "2020b4fc42dba44817983e06342e682ecfc3d2f484a581f11cc5731fbe4dce8a"
    CACHE STRING "CPM download hash")
set(CPM_REPOSITORY_URL
    "https://github.com/cpm-cmake/CPM.cmake"
    CACHE STRING "CPM repository URL")
...
if(NOT EXISTS ${CPM_DOWNLOAD_LOCATION}
   OR NOT CMPM_HASH_SUM MATCHES "^([0-9a-f]{64})$"
   OR NOT CMPM_HASH_SUM STREQUAL "SHA256=${CPM_HASH_SUM}")
    file(
        DOWNLOAD
