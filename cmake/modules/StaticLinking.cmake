...
function(enable_static_linking)
    ...
    if (CURRENT_COMPILER STREQUAL "CLANG" OR CURRENT_COMPILER MATCHES "GCC")
        append_flags_if_missing(CMAKE_EXE_LINKER_FLAGS "-static-libstdc++ -static-libgcc")
        append_flags_if_missing(CMAKE_SHARED_LINKER_FLAGS "-static-libstdc++ -static-libgcc")
    ...
    elseif (CURRENT_COMPILER STREQUAL "MSVC" OR CURRENT_COMPILER STREQUAL "CLANG-MSVC")
        append_flags_if_missing(CMAKE_MSVC_RUNTIME_LIBRARY "MultiThreaded$<$<CONFIG:Debug>:Debug>"  "MSVC runtime library" )
    ...
    elseif (CURRENT_COMPILER STREQUAL "EMSCRIPTEN")
        append_flags_if_missing(CMAKE_EXE_LINKER_FLAGS "-static-libstdc++ -s STANDALONE_WASM=1 -s WASM=1")
