...
function(get_current_compiler OUTPUT_VARIABLE)
    ...
    elseif("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang.*")
        ...
        if(CMAKE_SYSTEM_NAME STREQUAL "Emscripten"
           OR CMAKE_TOOLCHAIN_FILE MATCHES "emscripten"
           OR CMAKE_CXX_COMPILER MATCHES "em\\+\\+")
    ...
    if(ARG_INCLUDE_VERSION
       AND NOT DETECTED_COMPILER STREQUAL "${UNKNOWN_COMPILER}"
       AND DEFINED COMPILER_VERSION)
