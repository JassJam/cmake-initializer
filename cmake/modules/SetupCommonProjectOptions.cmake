...
function(target_setup_common_options TARGET_NAME)
    ...
    target_add_compiler_warnings(${TARGET_NAME} PRIVATE WARNINGS_AS_ERRORS
    ...
    set(ENABLE_SANITIZER_UNDEFINED_BEHAVIOR_VALUE
        ${ENABLE_SANITIZER_UNDEFINED_BEHAVIOR})
    ...
    if(DEFINED ARG_ENABLE_SANITIZER_UNDEFINED_BEHAVIOR)
        set(ENABLE_SANITIZER_UNDEFINED_BEHAVIOR_VALUE
            ${ARG_ENABLE_SANITIZER_UNDEFINED_BEHAVIOR})
    endif()
    ...
    if(ENABLE_CLANG_TIDY_VALUE OR ENABLE_CPPCHECK_VALUE)
        ...
        target_enable_static_analysis(${TARGET_NAME} ${STATIC_ANALYSIS_ARGS})
    endif()

    # Enable static linking if needed
    if(ENABLE_STATIC_RUNTIME)
        include(StaticLinking)
        targets_enable_static_linking(TARGETS ${TARGET_NAME})
    endif()

    # Enable unity build if needed
    if(ARG_ENABLE_UNITY_BUILD)
        set_target_properties(${TARGET_NAME}
                              PROPERTIES UNITY_BUILD ${ARG_ENABLE_UNITY_BUILD})
    endif()
endfunction()
