...
if(DEFINED ENV{EMSDK} AND EXISTS "$ENV{EMSDK}/upstream/emscripten")
    ...
    if(CMAKE_HOST_WIN32)
        set(CMAKE_C_COMPILER
            "${EMSCRIPTEN_ROOT_PATH}/emcc.bat"
            CACHE FILEPATH "C compiler")
        set(CMAKE_CXX_COMPILER
            "${EMSCRIPTEN_ROOT_PATH}/em++.bat"
            CACHE FILEPATH "C++ compiler")
    else()
        set(CMAKE_C_COMPILER
    ...
    message(
        FATAL_ERROR
            "Emscripten SDK not found. Please install EMSDK and set the EMSDK environment variable."
    )
endif()
